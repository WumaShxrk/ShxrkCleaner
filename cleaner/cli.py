...
def build_parser():
    ...
    parser.add_argument(
        "--epic", action="store_true", help="Clean Epic Games cache"
    )
    parser.add_argument(
        "--riot", action="store_true", help="Clean Riot Games cache"
    )
    parser.add_argument(
        "--ea", action="store_true", help="Clean EA App and Origin cache"
    )
    parser.add_argument(
        "--battlenet", action="store_true", help="Clean Battle.net cache"
    )
    parser.add_argument(
        "--ubisoft", action="store_true", help="Clean Ubisoft Connect cache"
    )
    parser.add_argument(
        "--whatsapp", action="store_true", help="Clean WhatsApp Desktop cache"
    )
    parser.add_argument(
        "--obs", action="store_true", help="Clean OBS Studio cache and logs"
    )
    parser.add_argument(
        "--gog", action="store_true", help="Clean GOG Galaxy cache"
    )
    return parser
